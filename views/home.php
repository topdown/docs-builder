...
<p>This will scan one directory back <code>../</code> for all <strong>.md</strong> files and generate templates to load via the package that is output in the build path.</p>
<p>The build path will be <code>build/{slug}/</code> and {slug} is generated from your config.php <code>DOCS_NAME</code>.</p>
<p>The command will try to create the build path and chmod it to <code>777</code>.
If this does not happen on your system you will have to run the commands</p>
